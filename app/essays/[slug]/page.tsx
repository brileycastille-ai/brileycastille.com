...
import "../essay-typography.css";

type Essay = {slug: string; title: string; dek: string; topics: string[]; content_html: string; published_at: string};
